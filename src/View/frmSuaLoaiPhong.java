 ...
 * @author ADMIN
 */
public class frmSuaLoaiPhong extends javax.swing.JFrame {

    public frmLoaiPhong csLoaiPhong;
    public clssLoaiPhong loaiphong;
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 38,
                                        Short.MAX_VALUE)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(btnDong, javax.swing.GroupLayout.PREFERRED_SIZE, 37,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnSua, javax.swing.GroupLayout.PREFERRED_SIZE, 37,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(25, 25, 25)));
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSuaActionPerformed
        ...
        String ten = this.txtTenLoaiPhong.getText();
        ...
        int ketqua = CSDL.tbPhong.SuaPhong(Integer.parseInt(id), ten, Float.parseFloat(dongia));
        if (ketqua == -1) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {
        this.txtID.setText(Integer.toString(loaiphong.getSTT()));
        this.txtTenLoaiPhong.setText(loaiphong.getLoaiPhong());
        this.txtDonGia.setText(Float.toString(loaiphong.getDonGia()));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSuaLoaiPhong.class.getName()).log(java.util.logging.Level.SEVERE,
                    null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmSuaLoaiPhong().setVisible(true);
            }
        });
    }
